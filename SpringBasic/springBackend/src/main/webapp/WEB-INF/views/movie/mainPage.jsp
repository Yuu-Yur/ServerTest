        ...
        <div class="row">
            <div class="col">
                <nav class="navbar navbar-expand-lg bg-body-tertiary">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="/movie/main">목록가기</a>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <c:forEach var="dto" items="${pageResponseDTON.dtoList}">
                                <tr>
                                    ...
                                    <td><c:out value="${dto.redate}"></c:out></td>
                                </tr>
                            </c:forEach>
...
// 글쓰기 폼으로 가야함.
    ...
    document.querySelector(".pagination").addEventListener("click",
        function (e) {
            ...
            // 백틱, 숫자 키보드 1번 왼쪽에 보면.
            //  기존 페이지 이동해서,
            // self.location = `/movie/main?page=\${num}`
            // 폼의 정보를 이용해서 이동.
