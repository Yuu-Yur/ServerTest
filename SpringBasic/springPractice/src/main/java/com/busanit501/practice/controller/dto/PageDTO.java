...
public class PageDTO {
    ...
    private int skip; // sql 용 수 (page - 1) * size;
    ...
    private List<FoodDTO> dtoList; // 현재 페이지에 보여줄 행들
    ...
    public PageDTO(List<FoodDTO> dtoList, int total, int pageSize, PageDTO pageDTO) {
